...
# -*- coding: utf-8 -*-
#
# TasTools documentation build configuration file, created by
...
latex_documents = [
  ('index', 'TasTools.tex', 'Half-Life Physics Documentation',
   'Matherunner', 'manual'),
]
...
man_pages = [
    ('index', 'tastools', 'TasTools Documentation',
     ['Airstrafers'], 1)
]
...
texinfo_documents = [
  ('index', 'TasTools', 'TasTools Documentation',
   'Airstrafers', 'TasTools', 'One line description of project.',
   'Miscellaneous'),
]
